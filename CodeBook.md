...
## transformations
### merge the train set and test set as one data set
### extract 79 columns from the 561 columns of the merged original data set by mean() and std()
### add activeties and subjects columns to the new merged data set
### aggregated the merged data set by activeties and subjects to the tidy data set
### add activety names column to the tidy data set
### export the tidy data set to file "tidydata.txt" with row.name=FALSE
